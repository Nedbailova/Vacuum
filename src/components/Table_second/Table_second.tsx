...
const addMode=(id:number, name:string, phases: number, duration: number)=>{
    setModes(newMode => [
      ...newMode,
  ...
  return (
    <div className='st'>
      ...
      <caption>Modes 
        ...
        <path d="M0 20H40" stroke="#DEDEDE" stroke-width="3"/>
        <path d="M20 0L20 40" stroke="#DEDEDE" stroke-width="3"/>
        </svg>
      </caption>
        <thead>
            <tr>
